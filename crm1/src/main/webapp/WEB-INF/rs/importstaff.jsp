...
<html>
  <head>
	...
	<div id="import-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:500px; padding:10px;">
		<form action="uploadfile.do" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-admin-add">
		
		<div class="row cl">
		<label class="form-label col-xs-6 col-sm-4" style="font-size: 18px">导入文件信息：</label>
			<div class="col-xs-8">
			    <input type="text" id="import-filename" name="filename" class="" readonly="readonly" data-options="required:true, missingMessage:'请选择文件'" >
			    <a onclick="uploadFile()" href="javascript:void(0)" id="select-file-btn" class="btn btn-success radius" style="lo">选择文件</a>
